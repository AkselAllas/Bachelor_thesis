...
params = {'dim': (8,8,5),
          ...
          'nb_classes': 28,
          'nb_channels': 22,
          'dir_path':'../cp_input_data/',
          'nb_tile_pixels':512*512,
          'tile_dimension':512,
          'shuffle': True}

list_IDs = ['1-1_(9,3)0','1-1_(9,3)1','1-1_(9,4)0','1-1_(9,4)1']
if(tile_arg=="0"):
    list_IDs=list_IDs[:2]
elif(tile_arg=="1"):
    list_IDs=list_IDs[2:4]
...
X_train, Y_train = training_generator.gene(list_IDs)
...
plotter.plot_model_prediction_v2(y_predictions, Y_train, name_arg, predictions_path)
